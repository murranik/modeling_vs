...
namespace YaHZ.modeling_test
{
	...
	partial class modeling_testDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			modeling_testSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	
	
	/// <summary>
	/// Helper class for serializing and deserializing modeling_test models.
	/// </summary>
	public abstract partial class modeling_testSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected modeling_testSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(modeling_testDomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new modeling_testSerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(modeling_testDomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(modeling_testSerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing modeling_test models.
	/// </summary>
	public sealed partial class modeling_testSerializationHelper : modeling_testSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private modeling_testSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static modeling_testSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static modeling_testSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (modeling_testSerializationHelper.instance == null)
					modeling_testSerializationHelper.instance = new modeling_testSerializationHelper();
				return modeling_testSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace YaHZ.modeling_test
{
	...
	partial class modeling_testSerializationHelperBase
	{
		...
		public virtual ExampleModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string location, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator, global::System.IO.Stream stream)
		{
			...
			{
				throw new global::System.InvalidOperationException(modeling_testDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			...
			if (modelRootSerializer != null)
			{
				...
				using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + location ?? "stream", true, transactionContext))
				{
					...
					if (stream.Length > 5)
					{
						try
						{
							global::System.Xml.XmlReaderSettings settings = modeling_testSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, ExampleModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			...
			using (global::System.IO.MemoryStream newFileContent = new global::System.IO.MemoryStream())
			{
				...
				global::System.Xml.XmlWriterSettings settings = modeling_testSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		public virtual void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer)
		{
			...
			rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/modeling_test";
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						modeling_testSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					modeling_testSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				modeling_testSerializationBehaviorSchemaValidationCallback validationCallback = new modeling_testSerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					modeling_testSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			modeling_testSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class modeling_testSerializationBehaviorSchemaValidationCallback
		{
			...
			internal modeling_testSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					modeling_testSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::YaHZ.modeling_test.ExampleModel modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace YaHZ.modeling_test
{
	...
	public partial class ExampleModel
	{
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = modeling_testSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									modeling_testDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
