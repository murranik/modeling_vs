...
namespace YaHZ.modeling_test
{
	...
	/// </remarks>
	public partial class modeling_testToolboxHelper : modeling_testToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new modeling_testToolboxHelper.
		/// </summary>
		public modeling_testToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	/// Helper class used to create and initialize toolbox items for this DSL.
	/// </summary>
	public abstract class modeling_testToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify modeling_test toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "modeling_test.1.0";

		private global::System.IServiceProvider sp;
		
		/// <summary>
		/// Constructs a new modeling_testToolboxHelperBase.
		/// </summary>
		protected modeling_testToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
