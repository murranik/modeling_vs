...
namespace YaHZ.modeling_test
{
	...
	public partial class ExampleModelSerializer : DslModeling::DomainClassXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				if (!reader.IsEmptyElement)
				{
					...
					modeling_testSerializationHelper.Instance.ReadExtensions(serializationContext, element, reader);
					...
					while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
					{
						...
						if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
						{
							...
							modeling_testSerializationBehaviorSerializationMessages.UnexpectedXmlElement(serializationContext, reader);
		...
		protected override void ReadPropertiesFromAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				string attribName = modeling_testSerializationHelper.Instance.ReadAttribute(serializationContext, element, reader, "name");
				if (attribName != null)
				{
					...
					{
						instanceOfExampleModel.Name = valueOfName;
					}
					else
					{	// Invalid property value, ignored.
						modeling_testSerializationBehaviorSerializationMessages.IgnoredPropertyValue(serializationContext, reader, "name", typeof(global::System.String), attribName);
					}
				}
			}
		}
		...
		private static void ReadChildElements(DslModeling::SerializationContext serializationContext, ExampleModel element, global::System.Xml.XmlReader reader)
		{
			if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				if (string.Compare(reader.LocalName, "exampleElements", global::System.StringComparison.CurrentCulture) == 0)
				{
					if (reader.IsEmptyElement)
					...
					{
						DslModeling::SerializationUtilities.SkipToFirstChild(reader);  // Skip the open tag of <exampleElements>
						ReadExampleModelHasExampleElementsInstances(serializationContext, element, reader);
						DslModeling::SerializationUtilities.Skip(reader);  // Skip the close tag of </exampleElements>
					}
				}
			}
		}
		...
		/// <summary>
		/// Reads all instances of relationship ExampleModelHasExampleElements.
		/// </summary>
		/// <remarks>
		...
		/// <param name="element">In-memory ExampleModel instance that will get the deserialized data.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		private static void ReadExampleModelHasExampleElementsInstances(DslModeling::SerializationContext serializationContext, ExampleModel element, global::System.Xml.XmlReader reader)
		{
			while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				DslModeling::DomainClassXmlSerializer newExampleElementOfExampleModelHasExampleElementsSerializer = serializationContext.Directory.GetSerializer(ExampleElement.DomainClassId);
				global::System.Diagnostics.Debug.Assert(newExampleElementOfExampleModelHasExampleElementsSerializer != null, "Cannot find serializer for ExampleElement!");
				ExampleElement newExampleElementOfExampleModelHasExampleElements = newExampleElementOfExampleModelHasExampleElementsSerializer.TryCreateInstance(serializationContext, reader, element.Partition) as ExampleElement;
				if (newExampleElementOfExampleModelHasExampleElements != null)
				{
					element.ExampleElements.Add(newExampleElementOfExampleModelHasExampleElements);
					DslModeling::DomainClassXmlSerializer targetSerializer = serializationContext.Directory.GetSerializer (newExampleElementOfExampleModelHasExampleElements.GetDomainClass().Id);	
					global::System.Diagnostics.Debug.Assert (targetSerializer != null, "Cannot find serializer for " + newExampleElementOfExampleModelHasExampleElements.GetDomainClass().Name + "!");
					targetSerializer.Read(serializationContext, newExampleElementOfExampleModelHasExampleElements, reader);
				}
				else
				{
					global::System.Type typeofExampleModelHasExampleElements = typeof(ExampleModelHasExampleElements);
					DslModeling::DomainRelationshipXmlSerializer newExampleModelHasExampleElementsSerializer = serializationContext.Directory.GetSerializer(ExampleModelHasExampleElements.DomainClassId) as DslModeling::DomainRelationshipXmlSerializer;
					global::System.Diagnostics.Debug.Assert(newExampleModelHasExampleElementsSerializer != null, "Cannot find serializer for ExampleModelHasExampleElements!");
					ExampleModelHasExampleElements newExampleModelHasExampleElements = newExampleModelHasExampleElementsSerializer.TryCreateInstance (serializationContext, reader, element.Partition) as ExampleModelHasExampleElements;
					if (newExampleModelHasExampleElements != null)
					{
						if (newExampleModelHasExampleElements.GetType() == typeofExampleModelHasExampleElements)
						{	// The relationship should be serialized in short-form.
							modeling_testSerializationBehaviorSerializationMessages.ExpectingShortFormRelationship(serializationContext, reader, typeof(ExampleModelHasExampleElements));
						}
						DslModeling::DomainRoleInfo.SetRolePlayer (newExampleModelHasExampleElements, ExampleModelHasExampleElements.ExampleModelDomainRoleId, element);
						DslModeling::DomainClassXmlSerializer targetSerializer = serializationContext.Directory.GetSerializer (newExampleModelHasExampleElements.GetDomainClass().Id);	
						global::System.Diagnostics.Debug.Assert (targetSerializer != null, "Cannot find serializer for " + newExampleModelHasExampleElements.GetDomainClass().Name + "!");
						targetSerializer.Read(serializationContext, newExampleModelHasExampleElements, reader);
					}
					else
		...
		protected override DslModeling::ModelElement CreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			...
			try
			{
				...
				{	// Create a default Id.
					...
					modeling_testSerializationBehaviorSerializationMessages.MissingId(serializationContext, reader, id);
				}
				else
				{
			...
			{	
				modeling_testSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "Id", typeof(global::System.Guid), idStr);
			}
		...
		{
			string monikerString = modeling_testSerializationHelper.Instance.ReadAttribute(serializationContext, sourceRolePlayer, reader, this.MonikerAttributeName);
	
			if (string.IsNullOrEmpty(monikerString))
			{	
				modeling_testSerializationBehaviorSerializationMessages.MissingMoniker(serializationContext, reader, this.MonikerAttributeName);
				return null;
			}
			...
			DslModeling::Moniker result = relSerializer.MonikerizeReference(serializationContext, sourceRolePlayer, ExampleModel.DomainClassId, monikerString, partition.Store);
		...
		public override void WriteMoniker(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::ModelElement sourceRolePlayer, DslModeling::DomainRelationshipXmlSerializer relSerializer)
		{
			...
			modeling_testSerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, this.MonikerAttributeName, monikerString);
		...
		public override void Write(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::RootElementSettings rootElementSettings)
		{
			...
			{
				modeling_testSerializationHelper.Instance.WriteExtensions(serializationContext, element, writer);
			}
		...
		protected override void WritePropertiesAsAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				global::System.String propValue = instanceOfExampleModel.Name;
				if (!serializationContext.Result.Failed)
				{
					modeling_testSerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, "name", propValue);
				}
			}
		}
		...
		private static void WriteChildElements(DslModeling::SerializationContext serializationContext, ExampleModel element, global::System.Xml.XmlWriter writer)
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<ExampleModelHasExampleElements> allExampleModelHasExampleElementsInstances = ExampleModelHasExampleElements.GetLinksToExampleElements(element);
			if (!serializationContext.Result.Failed && allExampleModelHasExampleElementsInstances.Count > 0)
			{
				writer.WriteStartElement("exampleElements");
				global::System.Type typeofExampleModelHasExampleElements = typeof(ExampleModelHasExampleElements);
				foreach (ExampleModelHasExampleElements eachExampleModelHasExampleElementsInstance in allExampleModelHasExampleElementsInstances)
				{
					if (serializationContext.Result.Failed)
						break;
	
					if (eachExampleModelHasExampleElementsInstance.GetType() != typeofExampleModelHasExampleElements)
					{	// Derived relationships will be serialized in full-form.
						DslModeling::DomainClassXmlSerializer derivedRelSerializer = serializationContext.Directory.GetSerializer(eachExampleModelHasExampleElementsInstance.GetDomainClass().Id);
						global::System.Diagnostics.Debug.Assert(derivedRelSerializer != null, "Cannot find serializer for " + eachExampleModelHasExampleElementsInstance.GetDomainClass().Name + "!");			
						derivedRelSerializer.Write(serializationContext, eachExampleModelHasExampleElementsInstance, writer);
					}
					else
					{	// No need to serialize the relationship itself, just serialize the role-player directly.
						DslModeling::ModelElement targetElement = eachExampleModelHasExampleElementsInstance.ExampleElement;
...
namespace YaHZ.modeling_test
{
	...
	public partial class ExampleElementSerializer : DslModeling::DomainClassXmlSerializer
	{
		...
		protected override void ReadPropertiesFromAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				string attribDescription = modeling_testSerializationHelper.Instance.ReadAttribute(serializationContext, element, reader, "description");
				if (attribDescription != null)
				{
					...
					{
						instanceOfExampleElement.Description = valueOfDescription;
					}
					else
					{	// Invalid property value, ignored.
						modeling_testSerializationBehaviorSerializationMessages.IgnoredPropertyValue(serializationContext, reader, "description", typeof(global::System.String), attribDescription);
					}
				}
			}
			// Value
			if (!serializationContext.Result.Failed)
			{
				string attribValue = modeling_testSerializationHelper.Instance.ReadAttribute(serializationContext, element, reader, "value");
				if (attribValue != null)
				{
					global::System.Int32 valueOfValue;
					if (DslModeling::SerializationUtilities.TryGetValue<global::System.Int32>(serializationContext, attribValue, out valueOfValue))
					{
						instanceOfExampleElement.Value = valueOfValue;
					}
					else
					{	// Invalid property value, ignored.
						modeling_testSerializationBehaviorSerializationMessages.IgnoredPropertyValue(serializationContext, reader, "value", typeof(global::System.Int32), attribValue);
					}
				}
			}
		}
		...
		protected override void WritePropertiesAsAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				global::System.String propValue = instanceOfExampleElement.Description;
				if (!serializationContext.Result.Failed)
				{
					if (!string.IsNullOrEmpty(propValue))
						modeling_testSerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, "description", propValue);
			...
			if (!serializationContext.Result.Failed)
			{
				global::System.Int32 propValue = instanceOfExampleElement.Value;
				...
				if (!serializationContext.Result.Failed)
				{
					modeling_testSerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, "value", serializedPropValue);
				}
			}
		}
...
{
	/// <summary>
	/// Serializer ExampleModelHasExampleElementsSerializer for DomainClass ExampleModelHasExampleElements.
	/// </summary>
	public partial class ExampleModelHasExampleElementsSerializer : DslModeling::DomainRelationshipXmlSerializer
	{
		#region Constructor
		/// <summary>
		/// ExampleModelHasExampleElementsSerializer Constructor
		/// </summary>
		public ExampleModelHasExampleElementsSerializer ()
			: base ()
		{
		}
		#endregion
		...
		#region Public Properties
		/// <summary>
		/// This is the XML tag name used to serialize an instance of ExampleModelHasExampleElements.
		/// </summary>
		public override string XmlTagName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return @"exampleModelHasExampleElements"; }
		}
	
		/// <summary>
		/// This is the XML tag name used to serialize a monikerized instance of ExampleModelHasExampleElements.
		/// </summary>
		public override string MonikerTagName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return @"exampleModelHasExampleElementsMoniker"; }
		}
		
		/// <summary>
		/// This is the name of the XML attribute that stores the moniker of ExampleModelHasExampleElements in a serialized monikerized instance.
		/// </summary>
		public override string MonikerAttributeName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
		...
		#region Read Methods
		/// <summary>
		/// Public Read() method that deserializes one ExampleModelHasExampleElements instance from XML.
		/// </summary>
		/// <remarks>
		/// When this method is called, caller guarantees that the passed-in XML reader is positioned at the open XML tag
		/// of the ExampleModelHasExampleElements element that is about to be deserialized. 
		/// The method needs to ensure that when it returns, the reader is positioned at the open XML tag of the next sibling element,
		/// or the close tag of the parent element (or EOF).
		/// </remarks>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">In-memory ExampleModelHasExampleElements instance that will get the deserialized data.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			#region Check Parameters
			...
			// Read nested XML elements, which include at least the instance of target role-player ExampleElement
			if (!serializationContext.Result.Failed)
			{
				if (!reader.IsEmptyElement)
				{
					...
					// Read target role-player ExampleElement.
				...
				{
					modeling_testSerializationBehaviorSerializationMessages.DanglingRelationship(serializationContext, reader, "ExampleModelHasExampleElements");
				}
			}
		...
		/// <summary>
		/// This method reads the target role player ExampleElement.
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">In-memory ExampleModelHasExampleElements instance that will link to the target ExampleElement instance.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		protected virtual void ReadTargetRolePlayer(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			// Read the instance of target role-player ExampleElement
			...
			while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				...
				if (targetRolePlayer != null)
				{
					...
					DslModeling::DomainRoleInfo.SetRolePlayer(element as DslModeling::ElementLink, ExampleModelHasExampleElements.ExampleElementDomainRoleId, targetRolePlayer);
		...
		/// <summary>
		/// This method creates a correct instance of ExampleModelHasExampleElements based on the tag currently pointed by the reader. If the reader
		/// is positioned at a serialized ExampleModelHasExampleElements, a new ExampleModelHasExampleElements instance will be created in the given partition, otherwise 
		/// null is returned.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		...
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="partition">Partition in which new elements should be created.</param>	
		/// <returns>Created ExampleModelHasExampleElements instance, or null if the reader is not pointing to a serialized ExampleModelHasExampleElements instance.</returns>
		public override DslModeling::ModelElement TryCreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (serializationContext != null);
		...
		/// <summary>
		/// This method creates a correct derived instance of ExampleModelHasExampleElements based on the tag currently pointed by the reader.
		/// Note that the difference between this method and the above one is that this method will never create an instance of the
		/// ExampleModelHasExampleElements type itself, only derived types are checked.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="partition">Partition in which new elements should be created.</param>
		/// <returns>Created instance that derives from ExampleModelHasExampleElements, or null if the reader is not pointing to such a serialized instance.</returns>
		...
		private DslModeling::ModelElement InternalTryCreateInstance (DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition, bool derivedTypesOnly)
		{
			...
			if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				...
				{	// New "ExampleModelHasExampleElements" instance.
					result = this.CreateInstance(serializationContext, reader, partition);
				}
				else
				{	// Check for derived classes of "ExampleModelHasExampleElements".
					if (this.derivedClasses == null)
						this.ConstructDerivedClassesLookupTable(serializationContext, partition.DomainDataDirectory);
					global::System.Diagnostics.Debug.Assert (this.derivedClasses != null);
					DslModeling::DomainClassInfo derivedClass = null;
					...
					{	// New derived relationship instance.
						ExampleModelHasExampleElementsSerializer derivedSerializer = serializationContext.Directory.GetSerializer(derivedClass.Id) as ExampleModelHasExampleElementsSerializer;
						global::System.Diagnostics.Debug.Assert(derivedSerializer != null, "Cannot find serializer for " + derivedClass.Name + "!");
						result = derivedSerializer.CreateInstance(serializationContext, reader, partition);
					}
				}
		...
		/// <summary>
		/// This method creates an instance of ExampleModelHasExampleElements based on the tag currently pointed by the reader. The reader is guaranteed (by the caller)
		/// to be pointed at a serialized instance of ExampleModelHasExampleElements.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the ModelRoot instance being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="partition">Partition in which new ExampleModelHasExampleElements instance should be created.</param>	
		/// <returns>Created ExampleModelHasExampleElements instance.</returns>
		protected override DslModeling::ModelElement CreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			string idStr = reader.GetAttribute ("Id");
			try
			{
				...
				return new ExampleModelHasExampleElements(
					partition,
					new DslModeling::RoleAssignment[] {
						DslModeling::RoleAssignment.CreatePlaceholderRoleAssignment (ExampleModelHasExampleElements.ExampleModelDomainRoleId), 
						DslModeling::RoleAssignment.CreatePlaceholderRoleAssignment (ExampleModelHasExampleElements.ExampleElementDomainRoleId)
					},
		...
		/// <summary>
		/// Stores a mapping from XmlTagName to DomainClassInfo that derives from ExampleModelHasExampleElements, created on demand.
		/// </summary>
		private global::System.Collections.Generic.Dictionary<string, DslModeling::DomainClassInfo> derivedClasses;
	
		/// <summary>
		/// Construct the apping from XmlTagName to DomainClassInfo that derives from ExampleModelHasExampleElements.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="domainDataDirectory">DomainDataDirectory to be used to discover all derived classes.</param>
		private void ConstructDerivedClassesLookupTable(DslModeling::SerializationContext serializationContext, DslModeling::DomainDataDirectory domainDataDirectory)
		{
			...
			DslModeling::DomainClassInfo thisClass = domainDataDirectory.GetDomainClass(ExampleModelHasExampleElements.DomainClassId);
			global::System.Diagnostics.Debug.Assert(thisClass != null, "Cannot find DomainClassInfo for ModelRoot!");
		...
		#region TryCreateMonikerInstance
		/// <summary>
		/// This method creates a Moniker of the correct derived (including ExampleModelHasExampleElements itself) instance of ExampleModelHasExampleElements based on the tag currently pointed by the reader.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		public override DslModeling::Moniker TryCreateMonikerInstance (DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::ModelElement sourceRolePlayer, global::System.Guid relDomainClassId, DslModeling::Partition partition)
		{
			...
			if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				string localName = reader.LocalName;
				if (string.Compare (localName, this.MonikerTagName, global::System.StringComparison.CurrentCulture) == 0)
				{	// New "ExampleModelHasExampleElements" moniker instance.
					result = this.CreateMonikerInstance(serializationContext, reader, sourceRolePlayer, relDomainClassId, partition);
				}
				else
				{	// Check for derived classes of "ExampleModelHasExampleElements".
		...
		/// <summary>
		/// This method creates a Moniker of ExampleModelHasExampleElements based on the tag currently pointed by the reader.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		protected override DslModeling::Moniker CreateMonikerInstance (DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::ModelElement sourceRolePlayer, global::System.Guid relDomainClassId, DslModeling::Partition partition)
		{
			...
			{	// Normalize the Id.
				...
				DslModeling::Moniker result = new DslModeling::Moniker(new DslModeling::MonikerKey(monikerString, relDomainClassId, ExampleModelHasExampleElements.DomainClassId, partition.Store), partition.Store);
				// Set location info if possible.
				result.Location = serializationContext.Location;
				global::System.Xml.IXmlLineInfo xmlLineInfo = reader as global::System.Xml.IXmlLineInfo;
				if (xmlLineInfo != null)
			...
			{
				modeling_testSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, this.MonikerAttributeName, typeof(global::System.Guid), monikerString);
				return null;
			}
		...
		/// <summary>
		/// Stores a mapping from Moniker Xml tag name to DomainClassInfo that derives from ExampleModelHasExampleElements, created on demand.
		/// </summary>
		private global::System.Collections.Generic.Dictionary<string, DslModeling::DomainClassInfo> derivedClassMonikers;
	
		/// <summary>
		/// Construct the mapping from Moniker Xml tag name to DomainClassInfo that derives from ExampleModelHasExampleElements.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="domainDataDirectory">DomainDataDirectory to be used to discover all derived classes.</param>
		private void ConstructDerivedClassMonikersLookupTable(DslModeling::SerializationContext serializationContext, DslModeling::DomainDataDirectory domainDataDirectory)
		...
		#region Write Methods
		/// <summary>
		/// Public WriteMoniker() method that writes a monikerized ExampleModelHasExampleElements instance into XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">ExampleModelHasExampleElements instance to be monikerized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		/// <param name="sourceRolePlayer">Source element that references the ExampleModelHasExampleElements instance being monikerized.</param>
		/// <param name="relSerializer">Serializer that handles the relationship connecting the source element to the ExampleModelHasExampleElements instance being monikerized.</param>
		public override void WriteMoniker(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::ModelElement sourceRolePlayer, DslModeling::DomainRelationshipXmlSerializer relSerializer)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (serializationContext != null);
		...
		/// <summary>
		/// Public Write() method that serializes one ExampleModelHasExampleElements instance into XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">ExampleModelHasExampleElements instance to be serialized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		/// <param name="rootElementSettings">
		/// The root element settings if the passed in element is serialized as a root element in the XML. The root element contains additional
		/// information like schema target namespace, version, etc.
		...
		#region Moniker Support
		/// <summary>
		/// This method calculates a moniker to a given ExampleModelHasExampleElements instance.
		/// </summary>
		/// <param name="directory">Directory to look up serializer based on model element type.</param>
		/// <param name="element">ExampleModelHasExampleElements instance to calculate qualified name for.</param>
		/// <returns>A fully qualified string moniker to the ExampleModelHasExampleElements instance.</returns>
		public override string CalculateQualifiedName(DslModeling::DomainXmlSerializerDirectory directory, DslModeling::ModelElement element)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (directory != null);
			...
			ExampleModelHasExampleElements instance = element as ExampleModelHasExampleElements;
			global::System.Diagnostics.Debug.Assert(instance != null, "Expecting an instance of ExampleModelHasExampleElements!");
		...
		/// </summary>
		/// <param name="directory">Directory to look up serializer based on model element type.</param>
		/// <param name="element">ExampleModelHasExampleElements instance to get moniker qualifier from.</param>
		/// <returns>
		/// Value of this element's moniker qualifier property, if it has one, or the value of the container's moniker qualifier property. Or empty string if this
		/// element is not monikerized using standard /qualifier/key mechanism.
		/// </returns>
...
{
	/// <summary>
	/// A DomainXmlSerializationBehavior implementation for defined behavior modeling_testSerializationBehavior.
	/// This is the abstract base of the double-derived implementation.
	/// </summary>
	[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Justification = "Generated code.")]		
	public abstract class modeling_testSerializationBehaviorBase : DslModeling::DomainXmlSerializationBehavior
	{
		///<summary>
		/// The xml namespace used by this domain model when serializing
		///</summary>
		public const string DomainModelXmlNamespace = @"http://schemas.microsoft.com/dsltools/modeling_test";
		...
		/// </summary>
		protected modeling_testSerializationBehaviorBase() : base() { }
		#endregion
		...
		public override global::System.Collections.ObjectModel.ReadOnlyCollection<DslModeling::DomainXmlSerializerDirectoryEntry> AllSerializers
		{
			get
			{
				if (modeling_testSerializationBehavior.serializerTypes == null)
				{
					...
					modeling_testSerializationBehavior.serializerTypes = new global::System.Collections.Generic.List<DslModeling::DomainXmlSerializerDirectoryEntry>(3 + customSerializerCount);
	
					#region Serializers defined in this model
					modeling_testSerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleModel.DomainClassId, typeof(ExampleModelSerializer)));
					modeling_testSerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleElement.DomainClassId, typeof(ExampleElementSerializer)));
					modeling_testSerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleModelHasExampleElements.DomainClassId, typeof(ExampleModelHasExampleElementsSerializer)));
					#endregion
					
					// Custom ones
					if (customSerializerCount > 0)
					{
						modeling_testSerializationBehavior.serializerTypes.AddRange(customSerializerTypes);
					}
				}
				return modeling_testSerializationBehavior.serializerTypes.AsReadOnly();
			}
		}
		...
		public override global::System.Collections.ObjectModel.ReadOnlyCollection<DslModeling::DomainXmlSerializerNamespaceEntry> AllNamespaces
		{
			get
			{
				if (modeling_testSerializationBehavior.namespaceEntries == null)
				{
					modeling_testSerializationBehavior.namespaceEntries = new global::System.Collections.Generic.List<DslModeling::DomainXmlSerializerNamespaceEntry>();
					modeling_testSerializationBehavior.namespaceEntries.Add(new DslModeling::DomainXmlSerializerNamespaceEntry(DomainModelXmlNamespace, typeof(global::YaHZ.modeling_test.modeling_testDomainModel)));
				}
				return modeling_testSerializationBehavior.namespaceEntries.AsReadOnly();
			}
		}
	...
	/// </summary>
	public sealed partial class modeling_testSerializationBehavior : modeling_testSerializationBehaviorBase
	{
		#region Singleton Instance
		/// <summary>
		/// Singleton instance.
		/// </summary>
		private static modeling_testSerializationBehavior instance;
	
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable (global::System.Diagnostics.DebuggerBrowsableState.Never)]	// Will trigger creation otherwise.
		public static modeling_testSerializationBehavior Instance
		{
			get
			{	// No need for synchronization. Most likely running in single-thread environment, and creating an extra instance
				// doesn't really hurt.
				if (modeling_testSerializationBehavior.instance == null)
					modeling_testSerializationBehavior.instance = new modeling_testSerializationBehavior ();
				return modeling_testSerializationBehavior.instance;
			}
		}
		...
		/// </summary>
		private modeling_testSerializationBehavior() : base() { }
		#endregion
	}
}
...
{
	/// <summary>
	/// Moniker resolver for serialization behavior modeling_testSerializationBehavior.
	/// </summary>
	public partial class modeling_testSerializationBehaviorMonikerResolver : modeling_testSerializationBehaviorMonikerResolverBase
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public modeling_testSerializationBehaviorMonikerResolver(DslModeling::Store store, DslModeling::DomainXmlSerializerDirectory directory)
	...
	/// <summary>
	/// Base moniker resolver for serialization behavior modeling_testSerializationBehavior.
	/// </summary>
	public partial class modeling_testSerializationBehaviorMonikerResolverBase : DslModeling::SimpleMonikerResolver
	{
		#region Member Variables
		/// <summary>
		...
		/// <param name="store">Store for this moniker resolver.</param>
		/// <param name="directory">Directory to used by this resolver to look up for serializers.</param>
		public modeling_testSerializationBehaviorMonikerResolverBase(DslModeling::Store store, DslModeling::DomainXmlSerializerDirectory directory)
			: base (store)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(directory != null);
		...
		protected override void OnUnresolvedMoniker(DslModeling::SerializationResult serializationResult, DslModeling::Moniker moniker)
		{
			...
			{
				modeling_testSerializationBehaviorSerializationMessages.UnresolvedMoniker(serializationResult, moniker);
			}
		}
		...
		protected override void OnMonikerResolvedToDuplicateLink(DslModeling::SerializationResult serializationResult, DslModeling::Moniker moniker)
		{
			if (serializationResult != null)
			{
				modeling_testSerializationBehaviorSerializationMessages.MonikerResolvedToDuplicateLink(serializationResult, moniker);
			}
		...
		protected override void OnAmbiguousMoniker(DslModeling::SerializationContext context, string moniker, DslModeling::ModelElement element1, DslModeling::ModelElement element2)
		{
			if (context != null)
			{
				modeling_testSerializationBehaviorSerializationMessages.AmbiguousMoniker(context, moniker, element1, element2);
			}
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return modeling_testSerializationBehaviorSerializationMessages.ResourceManager.GetString("CannotOpenDocument"); }
		}
		#endregion
	}
}
...
namespace YaHZ.modeling_test
{
	...
	/// </summary>
	public static partial class modeling_testSerializationBehaviorSerializationMessages
	{
		/// <summary>
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return modeling_testDomainModel.SingletonResourceManager; }
		}
...
namespace YaHZ.modeling_test
{
	...
	/// that can be used to serialize / deserialize the modeling_test domain model.
	/// </summary>
	/// <remarks>Double-derived class - the default implementation is in modeling_testDomainModelSerializerBase.
	...
	[DslModeling::DomainModelSerializer(typeof(global::YaHZ.modeling_test.modeling_testDomainModel), global::YaHZ.modeling_test.modeling_testSerializationBehavior.DomainModelXmlNamespace, "modelingtest")]
	public partial class modeling_testDomainModelSerializer : modeling_testDomainModelSerializerBase
	{
	}
	...
	/// </summary>
	public abstract partial class modeling_testDomainModelSerializerBase : DslModeling::IDomainModelSerializer
	{
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return global::YaHZ.modeling_test.modeling_testSerializationBehavior.DomainModelXmlNamespace; }
		}
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return typeof(global::YaHZ.modeling_test.modeling_testDomainModel); }
		}
			...
			DslModeling::ISerializerLocator serializerLocator)
		{
			...
			return modeling_testSerializationHelper.Instance.LoadModel(serializationResult, partition, fileName, null, null, serializerLocator);
		}
			...
			System.Text.Encoding encoding)
		{
			...
			global::YaHZ.modeling_test.ExampleModel rootElement = modelRoot as global::YaHZ.modeling_test.ExampleModel;
			if (rootElement == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::YaHZ.modeling_test.modeling_testDomainModel.SingletonResourceManager.GetString("InvalidSaveRootElementType"),
			...
			modeling_testSerializationHelper.Instance.SaveModel(serializationResult, rootElement, fileName,encoding, true);
		}
