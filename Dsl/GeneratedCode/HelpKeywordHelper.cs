...
namespace YaHZ.modeling_test
{
	...
	/// </remarks>
	public partial class modeling_testHelpKeywordHelper : modeling_testHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new modeling_testHelpKeywordHelper.
		/// </summary>
		protected modeling_testHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the modeling_testHelpKeywordHelper.
		/// </summary>
		public static modeling_testHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class modeling_testHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new modeling_testHelpKeywordHelperBase.
		/// </summary>
		protected modeling_testHelpKeywordHelperBase()
			: base() { }
