...
namespace YaHZ.modeling_test
{
	...
	///</remarks>
	internal partial class modeling_testDocView
	{
		#region Custom Editor and View setup

		private ModelViewControl windowsFormViewControl;

		/// <summary>
		/// Access to the Windows.Form View control that represents the Model
		/// </summary>
		protected ModelViewControl WindowsFormViewControl
		{
			get
			{
				if (this.windowsFormViewControl == null)
				{
					this.windowsFormViewControl = new ModelViewControl();
				}
