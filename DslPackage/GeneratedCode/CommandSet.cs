...
namespace YaHZ.modeling_test
{
	...
	/// </summary>
	internal partial class modeling_testCommandSet : modeling_testCommandSetBase
	{
		/// <summary>
		/// Constructs a new modeling_testCommandSet.
		/// </summary>
		public modeling_testCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class modeling_testCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new modeling_testCommandSetBase.
		/// </summary>
		protected modeling_testCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.Viewmodeling_testExplorerCommand,
				typeof(modeling_testEditorFactory).GUID);
		...
		{
			modeling_testExplorerToolWindow explorer = this.modeling_testExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected modeling_testDocData Currentmodeling_testDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as modeling_testDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected modeling_testDocView Currentmodeling_testDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as modeling_testDocView;
			}
		}
		...
		/// </summary>
		protected modeling_testExplorerToolWindow modeling_testExplorerToolWindow
		{
			get
			{
				modeling_testExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(modeling_testExplorerToolWindow), true) as modeling_testExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				modeling_testExplorerToolWindow explorerWindow = this.modeling_testExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class modeling_testClipboardCommandSet : modeling_testClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new modeling_testClipboardCommandSet.
		/// </summary>
		public modeling_testClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class modeling_testClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new modeling_testClipboardCommandSetBase.
		/// </summary>
		protected modeling_testClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
