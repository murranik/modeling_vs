...
namespace YaHZ.modeling_test
{
	...
	/// </summary>
	internal partial class modeling_testDocData : modeling_testDocDataBase
	{
		/// <summary>
		/// Constructs a new modeling_testDocData.
		/// </summary>
		public modeling_testDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a modeling_test document in memory.
	/// </summary>
	internal abstract partial class modeling_testDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new modeling_testDocDataBase.
		/// </summary>
		protected modeling_testDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::YaHZ.modeling_test.modeling_testDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::YaHZ.modeling_test.modeling_testDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::YaHZ.modeling_test.modeling_testDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::YaHZ.modeling_test.modeling_testDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::YaHZ.modeling_test.ExampleModel modelRoot = null;
			...
			modelRoot = global::YaHZ.modeling_test.modeling_testSerializationHelper.Instance.LoadModel(serializationResult, this.GetModelPartition(), fileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::YaHZ.modeling_test.modeling_testDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::YaHZ.modeling_test.ExampleModel modelRoot = (global::YaHZ.modeling_test.ExampleModel)this.RootElement;

			global::YaHZ.modeling_test.modeling_testSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			{
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::YaHZ.modeling_test.modeling_testDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		...
		protected override string SerializedModel
		{
			get
			{
				global::YaHZ.modeling_test.ExampleModel modelRoot = this.RootElement as global::YaHZ.modeling_test.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::YaHZ.modeling_test.modeling_testSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
