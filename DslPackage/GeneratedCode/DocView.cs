...
namespace YaHZ.modeling_test
{
	...
	/// </summary>
	[global::System.ComponentModel.ToolboxItemFilterAttribute(global::YaHZ.modeling_test.modeling_testToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require)]
	internal partial class modeling_testDocView : modeling_testDocViewBase
	{
		/// <summary>
		/// Constructs a new modeling_testDocView.
		/// </summary>
		public modeling_testDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
			: base(docData, serviceProvider)
		{
		}

		// This DSL defines a custom editor. Therefore, you must create a partial class of modeling_testDocView and
	...
	/// </summary>
	internal abstract class modeling_testDocViewBase : DslShell::ModelingDocView
	{
		/// <summary>
		/// Constructs a new modeling_testDocView.
		/// </summary>
		protected modeling_testDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
			...
			if(global::YaHZ.modeling_test.modeling_testHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::YaHZ.modeling_test.modeling_testHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
